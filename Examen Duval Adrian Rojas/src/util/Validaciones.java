...
public class Validaciones {
	...
	public static final String Grado="[A-Z0-9] {2,3}";
	public static final String ID = "[0-9]{8}";

	public static final String tar="[0-9][0-9][0-9][0-9][-][0-9][0-9][0-9][0-9][-][1][5][0-9][0-9][-][2][0][0-9][0-9]";
	public static final String TITULO = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{2,100}";
